...
<div class="signup-form">
    <registrationForm:form action="getRegistrationDetails" method="post" modelAttribute="registrationForm" >
        ...
        <div class="form-group">
			<div class="row">
				<div class="col-xs-12"><registrationForm:input type="text" class="form-control" path="userName" placeholder= "Name" pattern="^[A-Za-z\s]{1,}[\.]{0,1}[A-Za-z\s]{3,}$" title="username must have atleast 3 charecters"  required="required"/></div>	        
			</div>        	
        </div>
        <div class="form-group">

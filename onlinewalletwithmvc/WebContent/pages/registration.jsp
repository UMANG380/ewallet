...
<div class="signup-form">
    <registrationForm:form action="getRegistrationDetails" method="post" modelAttribute="registrationForm">
		...
		<div class="form-group">
            <registrationForm:input type="password" class="form-control" path="userPassword" placeholder="Password" required="required"/>
        </div>
		<div class="form-group">
		...
		<div class="form-group">
            <registrationForm:button type="submit" value="Register Now" class="btn btn-danger btn-lg btn-block"/>Register</button>
        </div>
